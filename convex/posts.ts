...
export const deletePost = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // verify ownership
        if(post.userId !== currentUser._id) throw new Error("Unauthorized to delete this post");

        // delete associated likes, comments and bookmarks
        ...
        await ctx.db.patch(currentUser._id, {
            // ensure post will not go below 0
